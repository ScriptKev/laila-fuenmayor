...
export const PresentationSection = () => {
  return (
    <section className='h-screen-25 w-full z-0 relative py-10 bg-presentationBg bg-center bg-no-repeat bg-cover'>
      {/* <Image alt='Mountains' src='/img/homePage/presentationBg.png' layout='fill' objectFit='cover' quality={100} /> */}

      <div className='text-left pl-20 w-170 h-full place-content-center flex flex-col justify-center items-center'>
